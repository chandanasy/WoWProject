                ...
                <div class="col-lg-3 col-md-3">
                    <div class="shop__sidebar">
                        ...
                        <div class="sidebar__filter">
                            ...
                            <a href="women.php?filter="><input type="submit" class="btn-submit" value="Filter"  style="border-radius: 10px; background-color:  #ca1515; border:0px; color: white;text-align: left; padding:5px;" /></a>
                        </form>
                        </div>
                        <?php 
                        $product_name=$_POST['search-input'];
                            $conn=mysqli_connect('localhost','root','','trendybucket') or die(mysqli_error());
                            $sql = "SELECT * FROM product WHERE tags LIKE '%".$product_name."%' ORDER BY id ASC";
